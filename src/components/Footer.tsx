    ...
    <footer className="border-t border-[#d2d2d7] px-6 py-10 dark:border-[#38383a]">
      <div className="mx-auto flex max-w-[980px] flex-col items-center gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-5">
            ...
            {DISCORD_URL && (
              <a
                ...
                className="flex items-center gap-1.5 text-[12px] text-[#86868b] transition-colors hover:text-[#5865F2]"
              >
        ...
        <p className="text-[12px] text-[#86868b]">
          有问题或建议？联系我们：
          <a
            href="mailto:yongbimsui9@gmail.com"
            className="ml-1 text-[#ff6b6b] hover:underline"
          >
